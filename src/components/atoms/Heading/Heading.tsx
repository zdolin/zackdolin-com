...
const headingStyles = cva('text-text-primary font-semibold tracking-wide', {
  variants: {
    level: {
      1: 'text-3xl md:text-2xl lg:text-4xl xl:text-5xl leading-[2.5rem] lg:leading-[3rem] xl:!leading-[3.2rem]',
      2: 'text-lg',
    },
  },
  defaultVariants: {

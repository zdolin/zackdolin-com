...
### Important Notes:
- Use accessible contrast between text and background colors.
...
- --hero-secondary: Background of the outer hero container.
- --hero-border: Outline around the avatar image.
